  ...
  */
  ...
  if (rank == 0) {
    ...
    json j_out = {
      ...
      {"_series_sy", all_sys},
      {"_series_sz", all_szs},
      {"_series_js_sx_vx_intrinsic", all_js_sx_vxs_intrinsic},
      {"_series_js_sx_vx_extrinsic", all_js_sx_vxs_extrinsic},
      {"_series_js_sx_vy_intrinsic", all_js_sx_vys_intrinsic},
      {"_series_js_sx_vy_extrinsic", all_js_sx_vys_extrinsic},
      {"_series_js_sy_vx_intrinsic", all_js_sy_vxs_intrinsic},
      {"_series_js_sy_vx_extrinsic", all_js_sy_vxs_extrinsic},
      {"_series_js_sy_vy_intrinsic", all_js_sy_vys_intrinsic},
      {"_series_js_sy_vy_extrinsic", all_js_sy_vys_extrinsic},
      {"_series_js_sz_vx_intrinsic", all_js_sz_vxs_intrinsic},
      {"_series_js_sz_vx_extrinsic", all_js_sz_vxs_extrinsic},
